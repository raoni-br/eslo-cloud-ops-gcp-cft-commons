...
output "org_registry_project_id" {
  value       = module.org_registry.project_id
  description = "The org registry project ID"
}

output "org_iac_project_id" {
  value       = module.org_iac.project_id
  description = "The org IaC project ID"
}
